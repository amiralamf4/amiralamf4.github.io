  ...
  return (
    <div className=' fixed top-0 left-0 w-full h-[5rem] flex justify-end z-20'>
      ...
      <div className='flex justify-between w-[50vw] md:w-[40vw] lg:w-[20rem] font-semibold tracking-wide md:text-[1rem]'>
        ...
        className=' relative bg-black w-1/2 h-14 flex items-end pl-5 cursor-pointer'>
          <div className='w-full h-full flex items-center'>
            <h3 ref={helloTextRef} className='w-full text-white font-[ligema] text-2xl md:text-4xl font-thin tracking-widest z-10 transition-all'>Say Hello</h3>
          </div>
        ...
        className='bg-black w-1/2 flex items-end pl-5 pb-1 cursor-pointer relative'>
          <div className='w-full h-full flex justify-center items-end'>
          <h3 ref={menuTextRef} className='w-full text-white font-[hermione] text-2xl md:text-3xl font-thin tracking-widest z-10 transitio-all'>Menu</h3>
          </div>
